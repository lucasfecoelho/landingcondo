...
export function Button({ children, className = "", variant = "primary", ...props }: ButtonProps) {
  ...
  const variants = {
    ...
    secondary:
      "border border-[rgba(18,37,66,0.16)] bg-white text-[var(--primary)] hover:-translate-y-0.5 hover:border-[rgba(18,37,66,0.32)] hover:bg-[var(--surface-muted)] hover:shadow-[0_16px_34px_rgba(18,37,66,0.08)] focus-visible:ring-[var(--primary)]",
    inverted:
